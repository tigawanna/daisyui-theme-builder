import { oklchColorObjectToString } from "./css-variables";



export const allThemeDefaults = {
  aqua: {
    "color-scheme": "dark",
    primary: "#09ecf3",
...
} as ConstrainDoubleRange


// import { oklchStringFromHex } from "../color-converters";
// function convertAnyRGBValuesIntoOKLCH() {
// Object.entries(allThemeDefaults).map(([key, value]) => {
//   Object.entries<string>(value).map(([key2, value2]) => {
//     // if (typeof value2 === 'string' && value2.includes('oklch')) {
//     //   allThemeDefaults[key][key2] = value2
//     // }
//     console.log({key, key2, value2})
//     if(value2.startsWith('#')) {
//       allThemeDefaults[key][key2] = oklchStringFromHex(value2);
//     }
//     if(value2.startsWith('oklch')) {
//       allThemeDefaults[key][key2] = value2.slice(6, -1);
//     }
//   })
// })

//   console.log("const allThemeDefaults =",allThemeDefaults)
// }

// convertAnyRGBValuesIntoOKLCH()
